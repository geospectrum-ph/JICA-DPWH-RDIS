  ...
  return(
    <div className='hazard-roadsections-container'>
      ...
      <div className='hazard-roadsections-list'>
        {selectedSection && hazardList.length > 0 ? hazardList.map((section) => {
          return <div className='hazard-list-item' style={{color: checkHazard(section.properties.HAZARD)}}
            onClick={()=>setSelectedHazard(section)}>
