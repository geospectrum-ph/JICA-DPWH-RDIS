    ...
    <div className='h-details-container'>
      ...
      <div className='h-details-body'>
        <div className='hazardm-body-causes'>
          <div className='hm-body-prop'><b>Item</b></div>
          <div className='hm-body-prop'><b>Factor</b></div>
          <div className='hm-body-prop'><b>Value/Category</b></div>
          <div className='hm-body-prop'><b>Point</b></div>
          ...
          <div className='hm-body-prop'>{'15<=h<30m'}</div>
          ...
          <div className='hm-body-prop'><i className='hm-prop-yes'>Collapsed slope (including past)</i></div>
          ...
          <div className='hm-body-prop' style={{gridColumnEnd: 'span 2'}}></div>
          ...
          <div className='hm-body-prop'>Slope direction of bedding plane or cracks</div>
          ...
          <div className='hm-body-prop'></div>
          <div className='hm-body-prop'>Non compounded sediment on impermeable bedrock</div>
          <div className='hm-body-prop'>Yes</div>
          <div className='hm-body-prop'>10</div>
          <div className='hm-body-prop'>0</div>
          ...
          <div className='hm-body-prop'></div>
          <div className='hm-body-prop'>Soil or bedrock condition</div>
          ...
          <div className='hm-body-prop'></div>
          <div className='hm-body-prop'></div>
          <div className='hm-body-prop'>Partle unstable</div>
          ...
          <div className='hm-body-prop'></div>
          <div className='hm-body-prop'>Water condition</div>
