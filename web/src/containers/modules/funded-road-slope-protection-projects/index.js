...
export default function PotentialRoadSlopeProtectionProjects () {
  ...
  function changeSelected (element) {
    const list = document.getElementById("funded-road-slope-protection-projects-container").getElementsByClassName("data-container-details");
  ...
  return (
    <div id = "funded-road-slope-protection-projects-container">
      <div>
        <div>
          <span>{ "Funded Road Slope Protection Projects Inventory" }</span>
        </div>
      </div>
      <div>
        {
